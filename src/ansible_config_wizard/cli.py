...
def main(
    ...
    vault_password_file: Optional[Path] = typer.Option(
        None,
        "--vault-password-file",
        help="Optional Ansible Vault password file used for vault encryption and preflight.",
    ),
    ...
    try:
        run_wizard(
            ...
            vault_password_file=vault_password_file.expanduser().resolve() if vault_password_file else None,
            assume_yes=yes,
